...
namespace assignment3 {
    public partial class Movie { //links Movie class from separate file
    }

    public partial class Show { //links Show class from separate file
    }

    public partial class Theatre { //links Theatre class from separate file
    }

    public partial class Time { //links Time class from separate file
    }

    public enum Day { Sun, Mon, Tue, Wed, Thu, Fri, Sat }

    [Flags]
    public enum Genre { Unrated = 0 , Action = 1 , Romance = 2 , Documentary = 4 , Mystery = 8 , Musical = 16 , Horror = 32 , Comedy = 64 , Fantasy = 128 , Animation = 256 , Adventure = 512 }

    class assignment3 {
        static void Main(string[] args) {
            Movie terminator = new Movie("Terminator 2: Judgement Day", 1991, 105); terminator.AddActor("Arnold Schwarzenegger"); 
